...
def ibutton(parent,text):
    store=Button(parent, text=text,bg="powder blue",relief="raised", 
                 font=('arial 15 bold'),width=10,height=2)
...
displaywidget=Entry(iframe(root), font=('arial 55 bold'),fg="blue",
    justify="right", relief="sunken",bd=4, textvariable=displayvar ) 
